-- Supabase Schema for Tenpheson Pre-Candidate Website
...
('Tenpheson destaca a importância da Saúde Preventiva no Vale do Jequitinhonha', 'Em entrevista local, o pré-candidato enfatizou que investir em esporte e saúde básica poupa vidas e recursos públicos.', 'O Vale do Jequitinhonha carece de infraestrutura de saúde ágil e humana. Tenpheson defende que a saúde começa na prevenção: "Precisamos de postos de saúde que funcionem e de incentivos para práticas esportivas na infância e na terceira idade. Cuidar das pessoas é o nosso dever principal".', '08 de Junho, 2026', '/images/jequitinhonha_landscape.png', 'Saúde e Bem-estar'),
('Da Multicell para a Liderança Comunitária: A trajetória de superação de Tenpheson', 'Conheça a história do empreendedor que gerou dezenas de empregos em Almenara e agora quer representar a região no Congresso Nacional.', 'Como fundador da Multicell, Tenpheson compreende as dificuldades de empreender no interior de Minas Gerais. Ele ressalta que o pequeno comerciante precisa de apoio, e não de entraves burocráticos. Sua história de vida inspira muitos jovens locais que buscam vencer através do trabalho correto e honesto.', '05 de Junho, 2026', '/images/tenpheson_portrait.png', 'Trajetória'),
('Debate sobre Incentivos Fiscais para o Norte e Nordeste de Minas Gerais', 'Tenpheson reúne-se com lideranças políticas para planejar projetos de atração de indústrias e empresas de tecnologia para a nossa região.', 'Atrair indústrias e empresas é o caminho definitivo para manter nossos jovens no Vale do Jequitinhonha. "Nossos talentos não podem ser obrigados a migrar para as grandes capitais por falta de emprego. Queremos que Almenara seja um polo de tecnologia e comércio", afirmou o pré-candidato.', '02 de Junho, 2026', '/images/jequitinhonha_landscape.png', 'Desenvolvimento');
*/
